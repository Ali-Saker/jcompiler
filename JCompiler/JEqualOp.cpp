...
JEqualOp::JEqualOp(int line, int col, JExpression *lhs, JExpression *rhs)
: JBoolBinaryExpression(line, col, lhs, rhs, "==")
{
}
void JEqualOp::preAnalyze(Context *surrounding){
	if (this->lhs != 0){
